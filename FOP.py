...
ap.add_argument(
    "--commit", "-c", help="Enable commit mode", action="store_true", default=False
)
arg = ap.parse_args()
...
KNOWNOPTIONS = (
    ...
    "redirect=google-analytics_ga.js",
    "redirect=google-analytics_analytics.js",
    "redirect=googletagservices_gpt.js",
    "redirect=google-analytics_cx_api.js",
    "redirect=googlesyndication_adsbygoogle.js",
    "redirect=doubleclick_instream_ad_status.js",
    "redirect=ampproject_v0.js",
    "redirect=noop.js",
    "redirect=noop.html",
    "redirect=noop.txt",
    "redirect=noop-0.1s.mp3",
    ...
    "redirect-rule=google-analytics_ga.js",
    "redirect-rule=google-analytics_analytics.js",
    "redirect-rule=googletagservices_gpt.js",
    "redirect-rule=google-analytics_cx_api.js",
    "redirect-rule=googlesyndication_adsbygoogle.js",
    "redirect-rule=doubleclick_instream_ad_status.js",
    "redirect-rule=ampproject_v0.js",
    "redirect-rule=noop.js",
    "redirect-rule=noop.html",
    "redirect-rule=noop.txt",
    "redirect-rule=noop-0.1s.mp3",
    "redirect-rule=noop-1s.mp4",
...
REPODEF = collections.namedtuple(
    "repodef",
        ...
        if domainlist:
            optionlist.append(
                "domain={domainlist}".format(
                    domainlist="|".join(
                        sorted(set(domainlist), key=lambda domain: domain.strip("~"))
                    )
                )
            )
